...
void
warthog::fch_bb_jpg_expansion_policy::compute_direction_labels()
{
...
void
warthog::fch_bb_jpg_expansion_policy::process_edge(
...
void
warthog::fch_bb_jpg_expansion_policy::label_edge(warthog::graph::edge* e, 

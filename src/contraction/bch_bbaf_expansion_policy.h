#ifndef WARTHOG_BCH_BBAF_EXPANSION_POLICY_H
#define WARTHOG_BCH_BBAF_EXPANSION_POLICY_H

// contraction/bch_bbaf_expansion_policy.h
//
...
class bch_bbaf_expansion_policy : public  expansion_policy
{
    public:
        ...
        bch_bbaf_expansion_policy(warthog::graph::planar_graph* g, 
                warthog::bbaf_filter* filter,
                bool backward=false);

        virtual 
        ~bch_bbaf_expansion_policy() { }
    ...
    private:
        ...
        typedef warthog::graph::edge_iter
                (warthog::bch_bbaf_expansion_policy::*chep_get_iter_fn) 

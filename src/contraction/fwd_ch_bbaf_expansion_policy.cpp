...
warthog::fwd_ch_bbaf_expansion_policy::fwd_ch_bbaf_expansion_policy(
...
void
warthog::fwd_ch_bbaf_expansion_policy::expand(
...
void
warthog::fwd_ch_bbaf_expansion_policy::get_xy(

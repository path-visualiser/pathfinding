...
void
warthog::fch_x_expansion_policy::expand(
...
void
warthog::fch_x_expansion_policy::get_xy(
...
warthog::search_node* 
warthog::fch_x_expansion_policy::generate_start_node(
...
warthog::search_node*
warthog::fch_x_expansion_policy::generate_target_node(
        warthog::problem_instance* pi)
{

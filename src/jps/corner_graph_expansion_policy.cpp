        ...
        warthog::search_node* current, warthog::problem_instance* problem)
{
    ...
    // the goal only has incoming arcs; no point expanding it
}

void
warthog::jps::corner_graph_expansion_policy::insert(
...
uint32_t
warthog::jps::corner_graph_expansion_policy::insert_start(
        uint32_t start_grid_id, uint32_t target_grid_id)
{
...
uint32_t
warthog::jps::corner_graph_expansion_policy::insert_target(
        uint32_t start_grid_id, uint32_t target_grid_id)
{
...
void
warthog::jps::corner_graph_expansion_policy::uninsert()
{

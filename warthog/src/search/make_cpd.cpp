         ...
         bool reverse, uint32_t seed, bool verbose=false)
{
    ...
    #endif
    {
        ...
        warthog::json_logger<warthog::bidirectional_graph_expansion_policy> logger(&expander);
        warthog::flexible_astar<
            warthog::zero_heuristic,
            warthog::bidirectional_graph_expansion_policy,
            warthog::json_logger<warthog::bidirectional_graph_expansion_policy>,
            warthog::pqueue_min,
            warthog::cpd::oracle_listener>
            dijk(&h, &expander, &logger, &queue);

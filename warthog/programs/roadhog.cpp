    ...
    warthog::dimacs_parser& parser, std::string alg_name)
{
    ...
    warthog::json_logger<warthog::simple_graph_expansion_policy> logger(&expander);

    warthog::flexible_astar<
        warthog::euclidean_heuristic,
        warthog::simple_graph_expansion_policy,
        warthog::json_logger<warthog::simple_graph_expansion_policy>,
        warthog::pqueue_min>
            alg(&h, &expander, &logger, &open);
    ...
    warthog::dimacs_parser& parser, std::string alg_name)
{
    ...
    warthog::euclidean_heuristic h(&g);
    warthog::pqueue_min open;
    warthog::json_logger<warthog::graph_expansion_policy<warthog::bb_filter>> logger(&expander);

    warthog::flexible_astar<
        warthog::euclidean_heuristic,
        warthog::graph_expansion_policy<warthog::bb_filter>,
        warthog::json_logger<warthog::graph_expansion_policy<warthog::bb_filter>>,
        warthog::pqueue_min>
            alg(&h, &expander, &logger, &open);
        ...
        std::string alg_name)
{
    ...
    warthog::zero_heuristic h;
    warthog::pqueue_min open;
    warthog::json_logger<warthog::bch_expansion_policy> logger(&bexp);

    warthog::flexible_astar<
        warthog::zero_heuristic,
        warthog::bch_expansion_policy,
        warthog::json_logger<warthog::bch_expansion_policy>,
        warthog::pqueue_min>
            alg(&h, &bexp, &logger, &open);
        ...
        std::string alg_name)
{
    ...
    warthog::euclidean_heuristic h(chd.g_);
    warthog::pqueue_min open;
    warthog::json_logger<warthog::fch_expansion_policy> logger(&fexp);

    warthog::flexible_astar<
        warthog::euclidean_heuristic,
        warthog::fch_expansion_policy,
        warthog::json_logger<warthog::fch_expansion_policy>,
        warthog::pqueue_min>
            alg(&h, &fexp, &logger, &open);
        ...
        std::string alg_name)
{
    ...
    warthog::euclidean_heuristic h(chd.g_);
    warthog::pqueue_min open;
    warthog::json_logger<warthog::fch_bb_expansion_policy> logger(&fexp);

    warthog::flexible_astar<
        warthog::euclidean_heuristic,
        warthog::fch_bb_expansion_policy,
        warthog::json_logger<warthog::fch_bb_expansion_policy>,
        warthog::pqueue_min>
            alg(&h, &fexp, &logger, &open);
    ...
    warthog::dimacs_parser& parser, std::string alg_name)
{
    ...
    warthog::zero_heuristic h;
    warthog::pqueue_min open;
    warthog::json_logger<warthog::cpd_graph_expansion_policy> logger(&expander);

    warthog::depth_first_search<
        warthog::zero_heuristic,
        warthog::cpd_graph_expansion_policy,
        warthog::json_logger<warthog::cpd_graph_expansion_policy>,
        warthog::pqueue_min>
            alg(&h, &expander, &logger, &open);

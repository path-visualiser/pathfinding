...
run_jpsplus(warthog::scenario_manager& scenmgr)
{
	...
	warthog::flexible_astar<
		...
		warthog::json_logger<
			warthog::jpsplus_expansion_policy>> astar(&heuristic, &expander, &logger);
...
run_jps2plus(warthog::scenario_manager& scenmgr)
{
	...
	warthog::flexible_astar<
		...
		warthog::json_logger<
			warthog::jps2plus_expansion_policy>> astar(&heuristic, &expander, &logger);
	astar.set_verbose(verbose);
...
run_jps2(warthog::scenario_manager& scenmgr)
{
	...
	warthog::flexible_astar<
		...
		warthog::json_logger<
			warthog::jps2_expansion_policy>> astar(&heuristic, &expander, &logger);
	astar.set_verbose(verbose);
...
run_jps(warthog::scenario_manager& scenmgr)
{
	...
	warthog::flexible_astar<
		...
		warthog::json_logger<
			warthog::jps_expansion_policy>> astar(&heuristic, &expander, &logger);
	astar.set_verbose(verbose);
...
run_astar(warthog::scenario_manager& scenmgr)
{
	...
	warthog::flexible_astar<
		...
		warthog::json_logger<
			warthog::gridmap_expansion_policy>> astar(&heuristic, &expander, &logger);
	astar.set_verbose(verbose);
...
run_wgm_astar(warthog::scenario_manager& scenmgr)
{
	...
	warthog::octile_heuristic heuristic(map.width(), map.height());
	warthog::json_logger<warthog::wgridmap_expansion_policy> logger(&expander);

	warthog::flexible_astar<
		warthog::octile_heuristic,
	   	warthog::wgridmap_expansion_policy,
		warthog::json_logger<
			warthog::wgridmap_expansion_policy>> astar(&heuristic, &expander, &logger);
	astar.set_verbose(verbose);
